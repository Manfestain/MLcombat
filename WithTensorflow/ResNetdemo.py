...
# 101层的ResNet
def resnet_v2_101(inputs, num_classes=None, global_pool=None, reuse=None, scope='resnet_v2_101'):
    blocks = [Block('block1', bottleneck, [(256, 64, 1)] * 2 + [(256, 64, 2)]),
              Block('block2', bottleneck, [(512, 128, 1)] * 3 + [(512, 128, 2)]),
...
# 200层的ResNet
def resnet_v2_200(inputs, num_classes=None, global_pool=None, reuse=None, scope='resnet_v2_200'):
    blocks = [Block('block1', bottleneck, [(256, 64, 1)] * 2 + [(256, 64, 2)]),
